...
int main() {
    ...
    RectangleOperationsTest::getDistanceTest(rec2, rec3, 1);
    RectangleOperationsTest::getAreaTest(rec1, 3);



//    double actualOutput = getDistance(rec1, rec2);
//	double res = getArea(rec2);
//    cout << actualOutput<<endl<<"area "<<res;
	return 0;
}
